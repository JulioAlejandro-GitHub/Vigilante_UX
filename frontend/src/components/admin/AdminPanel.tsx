...
export default function AdminPanel() {
  const [events, setEvents] = useState(mockEvents.filter(e => e.userType !== 'movimiento').slice(0, 20));
  ...
  const handleUpdateType = (id: string, newType: UserType) => {
    setEvents(events.map(e => e.id === id ? { ...e, userType: newType } : e));
  };
      ...
      <div className="bg-[#111111] border border-white/5 rounded-2xl overflow-hidden">
                ...
                <tr key={event.id} className="hover:bg-white/[0.01] transition-colors group">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-zinc-600 mt-0.5">10/03/2026 05:50</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4">
                    <select 
                      ...
                      onChange={(e) => handleUpdateType(event.id, e.target.value as UserType)}
        ...
        <div className="p-6 border-t border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-2 text-zinc-500 text-xs">
            ...
            <span>Los cambios en el tipo de usuario afectarán el historial forense.</span>
          </div>
          <div className="flex items-center gap-2">
